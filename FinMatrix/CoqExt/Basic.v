...
Reserved Notation "x \.* a"   (at level 60, format "x \.* a").  (* Scalar multiplication *)
...
Reserved Notation "V v.1"       (at level 2, left associativity, format "V v.1"). (* v[1] *)
Reserved Notation "V v.2"       (at level 2, left associativity, format "V v.2").
Reserved Notation "V v.3"       (at level 2, left associativity, format "V v.3").
Reserved Notation "V v.4"       (at level 2, left associativity, format "V v.4").
